...
QUERY_RESULTS_BUCKET = 's3://stock-query-results-location-de-project/'
MY_DATABASE = 'de_project_database'
SOURCE_PARQUET_TABLE_NAME = 'stock_data_parquet_tbl'
NEW_PROD_PARQUET_TABLE_NAME = 'stock_data_parquet_tbl_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://parquet-stock-table-prod'
